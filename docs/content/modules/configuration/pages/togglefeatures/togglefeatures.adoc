...
By default the new store name and legal name mapping is disabled, to ensure compatibility with existing deployments that have already onboarded sellers.
