...
PAYPAL_MIRAKL_OPERATOR_ACCESS_TOKEN (preferred, required for new Mirakl instances)
PAYPAL_MIRAKL_OPERATOR_API_KEY (deprecated, not available in new Mirakl instances)
