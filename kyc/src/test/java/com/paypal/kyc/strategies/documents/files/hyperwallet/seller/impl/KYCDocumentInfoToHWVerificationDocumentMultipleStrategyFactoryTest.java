...
class KYCDocumentInfoToHWVerificationDocumentMultipleStrategyFactoryTest {

	@InjectMocks
	private KYCDocumentInfoToHWVerificationDocumentMultipleStrategyFactory testObj;
	...
	@BeforeEach
	void setUp() {
		testObj = new KYCDocumentInfoToHWVerificationDocumentMultipleStrategyFactory(Set.of(strategyMock));
	}
