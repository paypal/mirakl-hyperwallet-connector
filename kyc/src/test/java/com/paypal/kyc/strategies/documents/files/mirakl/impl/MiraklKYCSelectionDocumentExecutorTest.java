...
class MiraklKYCSelectionDocumentExecutorTest {

	@InjectMocks
	private MiraklKYCSelectionDocumentExecutor testObj;
	...
	@BeforeEach
	void setUp() {
		testObj = new MiraklKYCSelectionDocumentExecutor(Collections.singleton(strategyMock));
	}
