...
class HyperWalletBankAccountServiceStrategyFactorySingleTest {

	@Spy
	@InjectMocks
	private HyperWalletBankAccountServiceStrategyFactorySingle testObj;
	...
	void getStrategies_shouldReturnConverterStrategyMock() {
		testObj = new HyperWalletBankAccountServiceStrategyFactorySingle(Set.of(strategyMock));
