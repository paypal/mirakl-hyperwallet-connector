...
class HyperwalletBankAccountCurrencyPriorityResolverTest {
	...
	private static List<HyperwalletBankAccountCurrencyInfo> currencies(Object... args) {
	...
	private static List<HyperwalletBankAccountCurrencyInfo> currenciesWithCountry(Object... args) {
		return IntStream.range(0, args.length)
				.filter(i -> i % 3 == 0)
	...
	private void assertSortedList(List<HyperwalletBankAccountCurrencyInfo> result, List<HyperwalletBankAccountCurrencyInfo> expected) {
