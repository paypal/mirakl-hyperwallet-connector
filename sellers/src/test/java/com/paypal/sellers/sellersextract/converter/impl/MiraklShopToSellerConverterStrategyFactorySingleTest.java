...
class MiraklShopToSellerConverterStrategyFactorySingleTest {

	@InjectMocks
	private MiraklShopToSellerConverterStrategyFactorySingle testObj;
	...
	@BeforeEach
	void setUp() {
		testObj = new MiraklShopToSellerConverterStrategyFactorySingle(Set.of(strategyMock));
	}
