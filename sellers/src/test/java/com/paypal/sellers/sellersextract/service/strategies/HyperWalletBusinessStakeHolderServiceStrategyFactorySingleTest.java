...
class HyperWalletBusinessStakeHolderServiceStrategyFactorySingleTest {

	@InjectMocks
	private HyperWalletBusinessStakeHolderServiceStrategyFactorySingle testObj;
	...
	@BeforeEach
	void setUp() {
		testObj = new HyperWalletBusinessStakeHolderServiceStrategyFactorySingle(Set.of(strategyMock));
	}
