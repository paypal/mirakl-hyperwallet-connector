...
@Slf4j
@Service
public class MiraklToBankAccountModelStrategyFactorySingle
		extends SingleAbstractStrategyFactory<MiraklShop, BankAccountModel> {

	private final Set<Strategy<MiraklShop, BankAccountModel>> strategies;

	public MiraklToBankAccountModelStrategyFactorySingle(final Set<Strategy<MiraklShop, BankAccountModel>> strategies) {
