...
@Slf4j
@Service
public class HyperWalletBankAccountServiceStrategyFactorySingle
		extends SingleAbstractStrategyFactory<SellerModel, Optional<HyperwalletBankAccount>> {

	private final Set<Strategy<SellerModel, Optional<HyperwalletBankAccount>>> strategies;

	public HyperWalletBankAccountServiceStrategyFactorySingle(
