...
class HyperwalletLoggingErrorsUtilTest {
	...
	void stringify_shouldPrintAllExceptionFields_forHyperwalletExceptionTypeA() {
		final HyperwalletException hyperwalletException = buildHyperwalletExceptionTypeA();
	...
	private HyperwalletException buildHyperwalletExceptionTypeC() {
		final RuntimeException e = new RuntimeException("EXCEPTION_MESSAGE");
		return new HyperwalletException(e);
	}

	private HyperwalletErrorList buildHyperwalletErrorList(final int num) {
		final HyperwalletErrorList hyperwalletErrorList = new HyperwalletErrorList();
		//@formatter:off
	...
	private HyperwalletError buildHyperwalletError(final int i) {
		//@formatter:off
