...
public enum KYCDocumentRejectedReasonEnum {
	...
	DOCUMENT_EXPIRED("Document is expired or not issued within specified timeframe."),
	...
	DOCUMENT_NOT_COMPLETE("Document is incomplete."), DOCUMENT_CORRECTION_REQUIRED("Document requires correction."),
	DOCUMENT_NOT_VALID_WITH_NOTES("Document is invalid and rejection details are noted on the account."),
	DOCUMENT_TYPE_NOT_VALID("Document type does not apply.");
