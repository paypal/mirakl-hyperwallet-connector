...
public enum KYCDocumentCategoryEnum {
	...
	public static KYCDocumentCategoryEnum getDocumentCategoryForField(final String fieldName) {
		return switch (fieldName) {
			...
			case KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK, KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT_BSH1,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT_BSH2,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT_BSH3,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT_BSH4,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_FRONT_BSH5,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK_BSH1,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK_BSH2,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK_BSH3,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK_BSH4,
					KYCConstants.HwDocuments.PROOF_OF_IDENTITY_BACK_BSH5 ->
				IDENTIFICATION;
			default -> UNKNOWN;
		};
	}
