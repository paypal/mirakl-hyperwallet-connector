...
public class MiraklAPIHealthCheckHealthIndicator implements HealthIndicator {
	...
	public MiraklAPIHealthCheckHealthIndicator(MiraklHealthCheckService miraklHealthCheckService,
			MiraklAPIHealthCheckActuatorConverter miraklAPIHealthCheckActuatorConverter) {
