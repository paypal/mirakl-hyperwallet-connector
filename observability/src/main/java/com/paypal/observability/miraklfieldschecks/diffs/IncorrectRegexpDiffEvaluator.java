...
public class IncorrectRegexpDiffEvaluator implements MiraklSchemaItemDiffEvaluator {
	...
	public Optional<MiraklSchemaDiffEntry> check(MiraklSchemaItem expected, MiraklSchemaItem actual) {
		...
		String expectedRegexpPattern = expectedField.getRegexpPattern() != null ? expectedField.getRegexpPattern() : "";
		String actualRegexpPattern = actualField.getRegexpPattern() != null ? actualField.getRegexpPattern() : "";
