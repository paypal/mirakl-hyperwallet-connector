...
class PaymentNotificationFactorySingleTest {

	@InjectMocks
	private PaymentNotificationFactorySingle testObj;
	...
	@BeforeEach
	void setUp() {
		testObj = new PaymentNotificationFactorySingle(Set.of(strategyMock));
	}
