...
class BankAccountRetryBatchJobItemsExtractorTest {
	...
	@InjectMocks
	private BankAccountRetryBatchJobItemsExtractor testObj;
	...
	@Test
	void getItem_shouldReturnBankAccountType() {
		final String result = testObj.getItemType();

		assertThat(result).isEqualTo(BankAccountExtractJobItem.ITEM_TYPE);
	}
