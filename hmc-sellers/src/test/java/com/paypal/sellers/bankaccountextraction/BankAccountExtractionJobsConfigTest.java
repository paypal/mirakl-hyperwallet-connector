...
class BankAccountExtractionJobsConfigTest {
	...
	@InjectMocks
	private BankAccountExtractionJobsConfig testObj;
	...
	void bankAccountExtractJob_createsJobDetailWithNameBankAccountJobAndTypeBankAccountExtractJob() {
		...
		assertThat(result.getJobClass()).hasSameClassAs(BankAccountExtractionJobsConfig.class);
