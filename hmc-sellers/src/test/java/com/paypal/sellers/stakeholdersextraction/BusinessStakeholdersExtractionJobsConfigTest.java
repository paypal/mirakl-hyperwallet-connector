...
class BusinessStakeholdersExtractionJobsConfigTest {
	...
	@InjectMocks
	private BusinessStakeholdersExtractionJobsConfig testObj;
	...
	void businessStakeholdersRetryJob_createsJobDetailWithNameBusinessStakeholderRetryJobAndBusinessStakeholdersRetryBatchJob() {
		...
		assertThat(result.getJobDataMap()).containsEntry(QuartzBatchJobBean.KEY_BATCH_JOB_BEAN,
				BusinessStakeholdersRetryBatchJob.class.getName());
	}
