...
public class MiraklShopsDocumentsEndpointMock extends AbstractResourceLoadingEndpointMock {
	...
	public MiraklShopsDocumentsEndpointMock(final MockServerClient mockServerClient) {
		super(mockServerClient);
	}

	public void getShopDocuments(final String shopId, final String responseFile) {
	...
	public void getShopDocument(final String documentId, final String responseFile) {
