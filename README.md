...
| `PAYPAL_HYPERWALLET_RETRY_FAILED_NOTIFICATIONS_CRON_EXPRESSION`     |   NO (default value: `* 0/15 * * * ? *`)                     | The cron expression to trigger periodically the Failed Notifications Retry Job.                                                                                                                                                                                                                                                                                                                      | `1 30 0 1/1 * ? *`                         |
...
| `notifications.retryfailed.scheduling.cronexpression`                 | 1 30 0 1/1 * ? *  | `notifications/src/main/resources/notifications.properties` |
