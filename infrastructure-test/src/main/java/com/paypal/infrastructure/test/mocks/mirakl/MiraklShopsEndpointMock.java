...
public class MiraklShopsEndpointMock extends AbstractResourceLoadingEndpointMock {
	...
	public MiraklShopsEndpointMock(MockServerClient mockServerClient) {
		super(mockServerClient);
	}

	public void getShops(Date updatedSince, boolean paginate, String responseFile) {
	...
	private static MiraklUpdateShopsRequest createUpdateShopRequest(long shopId) {
	...
	private static MiraklUpdatedShops createUpdateShopReturn(String shopId) {
